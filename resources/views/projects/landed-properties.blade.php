...
@section('title', 'Rumah Landed')
@section('description', 'Senarai rumah landed teres, banglo, dan semi-D. Daftar sekarang!')

@section('content')
<section class="page-banner">
    <div class="container">
        <h1>Rumah Landed</h1>
        <p>Senarai rumah landed teres, banglo, dan semi-D yang sedang dijual</p>
    </div>
</section>
...
<section class="projects-list-section">
    <div class="container">
        ...
        <div class="projects-grid">
            ...
            <div class="project-card">
                <div class="project-image">
                    ...
                    @endif
                    <span class="project-type badge-landed">Landed</span>
                </div>
        ...
        <div class="empty-state">
            <i class="fas fa-house"></i>
            <h3>Tiada Rumah Landed Buat Masa Sekarang</h3>
